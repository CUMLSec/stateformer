...
CHECKPOINT_PATH=checkpoints/finetune_signature
...
NUM_CLASSES=7         # int|char|float|void∗|enum|union|struct
ENCODER_EMB_DIM=768
ENCODER_LAYERS=8
ENCODER_ATTENTION_HEADS=12

CUDA_VISIBLE_DEVICES=0 python train.py \
  data-bin/finetune/signature \
  --num-classes $NUM_CLASSES \
  --task signature --criterion signature --arch roberta_mf_nau \
